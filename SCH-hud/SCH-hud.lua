...
local iPosition_x = 1400
local iPosition_y = 900

texts.visible(timer3, false)
texts.pos(timer3, iPosition_x + 65, iPosition_y + 20)
texts.bg_alpha(timer3, 0)
texts.size(timer3, 18)
...
texts.pos(stratcount, iPosition_x + 30, iPosition_y + 15)
texts.bg_alpha(stratcount, 0)
texts.size(stratcount, 24)
...
windower.register_event('load', function() 
	...
	windower.prim.set_size('grimoire-d', 120, 70)	
	...
	windower.prim.set_size('grimoire-da', 120, 70)
	...
	windower.prim.set_size('grimoire-l', 120, 70)	
	...
	windower.prim.set_size('grimoire-la', 120, 70)
