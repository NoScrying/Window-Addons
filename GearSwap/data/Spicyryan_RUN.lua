...
function get_sets()
	...
	Ogma.DA = { name= "Ogma's cape", augments={ 'STR+20','Accuracy+20 Attack+20','STR+10','"Dbl.Atk."+10', } }
...
-------TP Sets-------------------------------------------
	...
	sets.TankingTP.Magic3 = {

	}

	sets.TankingTP.Magic2	= {  --Ongo
...
------End of TP--------------------------------------------------------------------------------------------------------------------	
	...
	sets.Resolution.index = { 'AttackUncap' }
	Resolution_ind = 1
	...
	sets.Dimidiation.index = { 'AttackUncap'}
	Dimidiation_ind = 1
	...
	sets.Requiescat.index = { 'AttackUncap'}
	Requiescat_ind = 1
 ...
 --Ive never once used this WS on RUN, yet upon sharing my .lua with Carrot she called me out on this.
	...
	sets.SavageBlade.index = { 'AttackUncap'}
	SavageBlade_ind = 1
	...
	sets.BlackHalo.index = { 'AttackUncap'}
	BlackHalo_ind = 1
	...
	sets.Realmrazer.index = { 'AttackUncap'}
	Realmrazer_ind = 1
...
function IdleState()
	...
	if buffactive['Embolden'] then
		ChangeGear(set_combine(equipSet, {head="Erilaz Galea +2", hands="Regal Gauntlets", back="Evasionist's Cape", legs="Furthark Trousers +3"}))
	end
