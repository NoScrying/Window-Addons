xivhotbar_keybinds_job['Base'] = {
  -- Battle	
  -- Hotbar #1
 	{'b 1 4', 'ma', 'Poisona', 'stpc', 'Psna';"Elixir_B"},
    {'b 1 5',  'ma', 'Embrava', 'stpc', 'Embrva',"Tome_of_Justice"},
    {'b 1 7',  'ja', 'Accession', 'me', 'AoE',"Epilogue-_Unbroken_Lines"},
  	{'b 1 8', 'ma', 'Adloquium', 'stpc', 'Adlo',"tile761"},
  ...
  -- Hotbar #3
  	{'b 3 1', 'ma', 'Cure IV', 'stpc', 'Cure IV',"tile792"},
  	{'b 3 2', 'ma', 'Cure III', 'stpc', 'Cure III',"tile078"},
  ...
  -- Movement Spells
	{'b 6 1', 'ma', 'Firestorm II', 'stpc', 'Storm.F', 'Activate..._(red)'},
	{'b 6 2', 'ma', 'Hailstorm II', 'stpc', 'Storm.B', 'Ice_Wall'},
	{'b 6 3', 'ma', 'Windstorm II', 'stpc', 'Storm.W', 'Activate..._(green)'},
	{'b 6 4', 'ma', 'Sandstorm II', 'stpc', 'Storm.S', 'Activate..._(yellow)'},
	{'b 6 5', 'ma', 'Thunderstorm II', 'stpc', 'Storm.T', 'Activate..._(purple)'},	
	
	{'b 6 6', 'ma', 'Voidstorm II', 'stpc', 'Void', 'Call_Forth_Magic'},
	{'b 6 7', 'ma', 'Aurorastorm II', 'stpc', 'Aurora', 'Center_Your_Mind'},

	-- Dark Arts
--Bar #1
	{'f 3 8', 'ma', 'Aspir', 't', 'Aspir',"Life_Transfer"},
	{'f 4 8', 'ma', 'Aspir II', 't', 'Aspir II',"Unholy_Feast"},
 	{'f 1 4', 'ma', 'Ice Spikes', 'me', 'Ice',"tile175"},

	{'f 1 8', 'ma', 'Dispel', 'stnpc', 'Dispel',"tile877"},
	{'f 1 9', 'ma', 'Break', 'stnpc', 'Break',"tile009"},
	{'f 1 10', 'ma', 'Sleep II', 'stnpc', 'Sleep','tile944'},
--Bar #2
	{'f 2 1', 'input', '//exec SCH_Fusion.txt', 'me', 'Fusion', "Fusion"},
...
--Bar #3
	{'f 3 1', 'ma', 'Pyrohelix II', 't', 'Pyro',"Overload_Fire"},
	{'f 3 2', 'ma', 'Cryohelix II', 't', 'Cryo',"Geyser"},
	{'f 3 3', 'ma', 'Anemohelix II', 't', 'Anemo',"Tornado(2)"},
	{'f 3 4', 'ma', 'Geohelix II', 't', 'Geo',"Woven_Earth"},
	{'f 3 5', 'ma', 'Ionohelix II', 't', 'Iono',"Elemental_Requiem"},
...
--Bar #4
	...
	{'f 4 10',  'ja', 'Tabula Rasa', 'me', 'Tabula',"Woven_Air"},
...
xivhotbar_keybinds_job['Light Arts'] = {
  ...
  {'b 1 6',  'ja', 'Perpetuance', 'me', 'Dura.+',"Chapter_2-_Igniting_Burst"},
...
xivhotbar_keybinds_job['Dark Arts'] = {
  ...
  --{'b 4 1',  'ja', 'Parsimony', 'me', 'MP 1/2'},
 	...
 	{'f 1 7',  'ja', 'Manifestation', 'me', 'AoE',"Soul_Spiral"},

    {'f 4 7',  'ja', 'Ebullience', 'me', 'Amp+',"Tailored_Victory"},
	{'f 4 9',  'ja', 'Immanence', 'me', 'SC',"Singularity_Shot"},

	{'f 4 1', 'ma', 'Fire V', 't', 'Fire V',"Wildfire"},
	{'f 4 2', 'ma', 'Blizzard V', 't', 'Bliz V',"Frozen_Fusillade"},
	{'f 4 3', 'ma', 'Aero V', 't', 'Aero V',"Cleansing_Typhoon"},
	{'f 4 4', 'ma', 'Stone V', 't', 'Stone V',"Stoning"},
	{'f 4 5', 'ma', 'Thunder V', 't', 'Thun V',"Derecho"},
	{'f 4 6', 'ma', 'Water V', 't', 'Water V',"Tidal_Surge"},
...
xivhotbar_keybinds_job['Club'] = {
	...
	{'b 1 2', 'weaponskill',  'Realmrazer', 't', 'Realm', 'Club-Single'}, 
