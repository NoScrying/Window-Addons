xivhotbar_keybinds_job['Base'] = {
 -- Hotbar #1
	...
	{'b 1 8', 'ja', 'Sange', 'me', 'R. ATK++'},
	{'b 1 9', 'ja', 'Futae', 'me', 'M. ATK+'},
 -- Hotbar #2
 ...
 -- Hotbar #4
	...
	{'b 4 3', 'ma', 'Yain: Ichi', 'me', 'Enmity-'},
	{'b 4 4', 'ma', 'Gekka: Ichi', 'me', 'Enmity+'},
...
xivhotbar_keybinds_job['Katana'] = {
	-- Battle
  	{'b 1 1', 'weaponskill', 'Blade: Shun', 't', 'Shun', 'Katana-Shun'},
  	{'b 1 2', 'weaponskill', 'Blade: Hi', 't', 'Hi ', 'Katana-Single'},
  	{'b 1 3', 'weaponskill', 'Blade: Ku', 't', 'Ku', 'Katana-Ku'},
  	{'b 1 4', 'weaponskill', 'Blade: Ten', 't', 'Ten', 'Katana-Ten'},
	
	{'b 2 1', 'weaponskill', 'Blade: Yu', 't', 'Yu', 'Katana-Yu'},
	{'b 2 2', 'weaponskill', 'Blade: Chi', 't', 'Chi', 'Katana-Chi'},
	{'b 2 3', 'weaponskill', 'Blade: To', 't', 'To', 'Katana-To'c},
