...
xivhotbar_keybinds_general['Root'] = {
    ...
    {'f 6 6',  'input', '//send Nolyte //exec AttackOff.txt', 'me', 'Off','Auto-attack_Icon'},	
    
	{'f 6 7',  'input', '//send Nolyte //atkwm slave on', 'me', 'Attack', 'Auto-attack_Icon'},	
    --{'f 6 7',  'input', '//send Nolyte //aa on', 'me', 'Attack', 'Auto-attack_Icon'},
	
    {'f 2 10',  'input', '//send Nolyte //exec MoveSpeed.txt', 'me', 'Mazurka','Overwhelming_Celerity'},	
