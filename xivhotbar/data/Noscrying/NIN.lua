xivhotbar_keybinds_job['Base'] = {
 ...
 -- Hotbar #2
	...
	{'f 2 6', 'ma', 'Suiton: San', 't', 'Water'},
 -- Hotbar #3

 -- Hotbar #4
	{'b 4 1', 'ma', 'Utsusemi: Ichi', 'me', 'Utsu', 'UtsuIchi'},
	{'b 4 2', 'ma', 'Utsusemi: Ni', 'me', 'Utsu', 'UtsuNi'},
	{'b 4 3', 'ma', 'Utsusemi: San', 'me', 'Utsu', 'Hide'},
	{'b 4 4', 'ma', 'Yain: Ichi', 'me', 'Enmity-'},
	{'b 4 5', 'ma', 'Gekka: Ichi', 'me', 'Enmity+'},
...
xivhotbar_keybinds_job['THF'] = {
    ...
    {'b 3 7',  'ja', 'Sneak Attack', 'me', 'Snk. Atk', 'snkatk'},
    {'b 3 8',  'ja', 'Trick Attack', 'me', 'Trk. Atk', 'Innin'},
...
xivhotbar_keybinds_job['Katana'] = {
	-- Battle
  	{'b 1 1', 'weaponskill', 'Blade: Metsu', 't', 'Metsu', 'Raiju'},
  	{'b 1 2', 'weaponskill', 'Blade: Shun', 't', 'Shun', 'Katana-Shun'},
  	{'b 1 4', 'weaponskill', 'Blade: Hi', 't', 'Hi ', 'Katana-Single'},
  	{'b 1 5', 'weaponskill', 'Blade: Ku', 't', 'Ku', 'Katana-Ku'},
  	{'b 1 3', 'weaponskill', 'Blade: Ten', 't', 'Ten', 'Katana-Ten'},
	
	{'b 2 1', 'weaponskill', 'Blade: Ei', 't', 'Ei', 'Katana-Yu'},
	{'b 2 2', 'weaponskill', 'Blade: Chi', 't', 'Chi', 'Katana-Chi'},
	{'b 2 3', 'weaponskill', 'Blade: To', 't', 'To', 'Katana-To'},
	{'b 2 4', 'weaponskill', 'Blade: Kamu', 't', 'Kamu', 'Katana-Kamu'},
	
  	{'f 1 1', 'weaponskill', 'Blade: Metsu', 't', 'Metsu', 'Raiju'},
  	{'f 1 2', 'weaponskill', 'Blade: Shun', 't', 'Shun', 'Katana-Shun'},
  	{'f 1 5', 'weaponskill', 'Blade: Hi', 't', 'Hi ', 'Katana-Single'},
	{'f 1 4', 'weaponskill', 'Blade: Chi', 't', 'Chi', 'Katana-Chi'},
  	{'f 1 3', 'weaponskill', 'Blade: Ten', 't', 'Ten', 'Katana-Ten'},
}
